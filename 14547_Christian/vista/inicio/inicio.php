...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #d6d6ee">
...
<div class="alert alert-success alert-dismissible fade" style="position: fixed; top: 8%; right: 0; z-index: 10000;" id="alerta_login_correcto">
  <img src="configuracion/imagenes/bien.png" style="width: 15%;" class="card-img-top" alt="...">
...
<div class="alert alert-danger alert-dismissible fade" style="position: fixed; top: 8%; right: 0; z-index: 10000;" id="alerta_login_error">
  <img >
  <img src="configuracion/imagenes/error.png" style="width: 15%;" class="card-img-top" alt="...">
  <p id="texto_error"></p>
</div>
