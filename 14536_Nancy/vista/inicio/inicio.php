...
<head>
    ...
    <link href="../../configuracion/css/style.css" rel="stylesheet" type="text/css">
</head>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarColor01">
                ...
                <form class="d-flex">
                    ...
                    <button class="btn btn-secondary my-2 my-sm-0 btn btn-warning" type="submit">Search</button>
    ...
    <div class="container-lg p-3 mt-5" style="text-align: center;">
        ...
        <div class="row row-cols-1 row-cols-md-2 g-4">
            <div class="col">
                <div class="card">
                    <center>
                        <img src="configuracion/imagenes/user.png" style="width: 15%;" class="card-img-top" alt="...">
                    </center>
                    <div class="card-body">
                        <h5 class="card-title">Login Usuario</h5>
                        <p class="card-text"><button data-bs-toggle="modal" data-bs-target="#modal_login_usuario"
                                class="btn btn-warning">Ingresar</button></p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="card">
                    <center>
                        <img src="configuracion/imagenes/admin.png" style="width: 15%;" class="card-img-top" alt="...">
                    </center>
                    <div class="card-body">
...
<!-- FIN DE ALERTAS PARA LOGIN-->
    ...
    <img src="../../configuracion/imagenes/dogo.jpg" class="rounded mx-auto d-block img-fluid" alt="...">
